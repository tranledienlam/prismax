...
📌 **Trang dự án**: [app.prismax.ai](https://app.prismax.ai/)
...
<p align="center">
    <a href="https://youtu.be/4wP4aXkugdg">
        <img src="https://img.youtube.com/vi/4wP4aXkugdg/maxresdefault.jpg" alt="Xem video demo">
    </a>
</p>
...
- **Mở web và gửi tin nhắn**: Mở trang dự án kiếm 10 point và gửi tin nhắn kiếm 50 point hằng ngày

---

## 🔧 Yêu cầu ban đầu

- **Google**: Đăng nhập vào dự án bằng google trước. Duyệt trình sẽ ghi nhớ trạng thái đăng nhập của những lần sau.
...
2. **Tạo môi trường ảo**
   ...
   ```sh
   python -m venv venv-browserkit1.1.3
   ```
...
3. **Kích hoạt môi trường ảo**
   ...
   * **Windows**
     ...
     ```sh
     venv-browserkit1.1.3\Scripts\activate
     ```
   * **Linux/macOS**

     ```sh
     source venv-browserkit1.1.3/bin/activate
     ```
